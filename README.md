<<<<<<< HEAD
# MOTTONI N8N Automation System

## Kurulum
1. `docker-compose up -d`
2. http://localhost:5678 aç
3. admin / Bsxxx??? ile giriş yap

## Aktif Workflow'lar
- **MOTTONI AI Advanced Bot** - Hafızalı, öğrenen ve kategorize eden AI uzman
- **MOTTONI AI Telegram Bot** - Basit AI asistan (arşivlendi)

## Arşivlenmiş Workflow'lar (archive/)
- AI Teknik Destek
- Email Kampanya Otomasyonu  
- Lead Generation

## Deploy
`Ctrl+Shift+P` → "Tasks: Run Task" → "Deploy to Render"
=======
# **n8n-render README**
...
>>>>>>> de8f6623ccef01625a4f8e648781993cecfafd37
